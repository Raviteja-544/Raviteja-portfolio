...
const Contact = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			const response = await emailjs.send(
				...
				{
					from_name: username,
					to_name: "Ganta Ravi Teja",
					reply_to: user_email,
					to_email: "ravi41v7729@gmail.com",
	...
	return (
		<div className='relative z-0 bg-black w-full min-h-screen flex flex-col justify-between mt-12'>
			<div className='text-white contact overflow-x-hidden pt-0 mt-8 flex-grow' id='contact'>
				<div className='z-10 w-full sm:w-[650px] m-auto p-8 rounded-2xl'>
					...
					>
						...
						<button
							type='submit'
							className='py-2 px-6 rounded-xl outline-none w-fit font-bold shadow-md bg-gray-900'
						>
